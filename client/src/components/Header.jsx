...
export default function Header() {
  ...
  return (
    <header className='bg-slate-200 opacity-60'>
        ...
        <Link to='/'><li className='hidden sm:inline text-stone-950 hover:underline'>Home</li></Link>

        <Link to='about'><li className='hidden text-stone-950 sm:inline hover:underline'>About</li></Link>

        <Link to='sign-up'><li className='hidden text-stone-950 sm:inline hover:underline'>Sign Up</li></Link>
